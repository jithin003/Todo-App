...
module.exports = __webpack_require__(/*! E:\protacked\newapp\src\main.ts */"zUnb");
...
const routes = [
    ...
    {
        path: 'add-todo',
        loadChildren: () => __webpack_require__.e(/*! import() | add-todo-add-todo-module */ "common").then(__webpack_require__.bind(null, /*! ./add-todo/add-todo.module */ "92tL")).then(m => m.AddTodoPageModule)
    },
    {
        path: 'accordion',
        loadChildren: () => __webpack_require__.e(/*! import() | accordion-accordion-module */ "default~accordion-accordion-module~tab1-tab1-module").then(__webpack_require__.bind(null, /*! ./accordion/accordion.module */ "pvM+")).then(m => m.AccordionPageModule)
    },
];
